        ...
        <section class="content pure-u-1 pure-u-md-4-5">
            ...
            <table class="pure-table">
                    ...
                    <tr>
                        <td colspan="3">
                            <form action="?controleur=taches&action=lister" class="pure-form" method="post">
                                ...
                                <input type="text" size="60" name="texte" id="tache-texte">
                                <input type="submit" value="Rechercher" class="pure-button pure-button-primary">
                            </form>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                           <form action="?controleur=taches&action=lister" class="pure-form" method="post">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="tache-texte">
                                <label class="form-check-label" for="exampleCheck1" data-filter="id">Toutes les tâches</label>
                            
                                <input type="checkbox" class="form-check-input" id="tache-texte">
                                <label class="form-check-label" for="exampleCheck1">Tâches terminées</label>
                            
                                <input type="checkbox" class="form-check-input" id="tache-texte">
                                <label class="form-check-label" for="exampleCheck1">Tâches en cours</label>
                            </div>
                            </form>
                        </td>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <form action="?controleur=taches&action=modifier" class="pure-form id" method="post">
